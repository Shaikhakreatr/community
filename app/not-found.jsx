      ...
      <main className="bg-img fixed h-[100%] bg-contain pt-[6.25rem] ">
        ...
        <div className="container mx-auto mb-[6.25rem] mt-[8.75rem] sm:mt-[100px] lg:mt-[60px]">
          <div className=" mt-[3rem] grid grid-cols-1 sm:grid-cols-5 md:grid-cols-5 lg:ml-4">
            <div className="order-2 mt-[4.125rem] flex flex-col items-center justify-center sm:order-1 sm:col-span-1 sm:mb-[70px] sm:ml-[20px] sm:mt-[196px] sm:items-start md:mb-[4.75rem] md:ml-[3.125rem]  md:mr-[-4.6875rem] md:mt-[11.75rem] lg:mr-[-4.6875rem] lg:mt-[240px] xl:mt-[25.3125rem]">
            ...
            <div className="static order-1 sm:relative sm:order-2 sm:col-span-4 sm:mx-0">
              <img
                ...
                className="static mx-auto h-[12.8469rem] w-[20rem] sm:absolute  sm:left-[15px] sm:top-[-75px] sm:h-[400px] sm:w-[450px] md:left-[45px] md:top-[-75px] md:h-[410px] md:w-[500px] lg:left-[120px] lg:top-[-35px] lg:h-[400px] lg:w-[800px] xl:left-[5.375rem] xl:top-[-1.25rem] xl:h-[40.3862rem] xl:w-[62.8719rem]"
                alt="page not found"
              />
            </div>
          </div>
