...
const AccordianSection = () => {
  ...
  const rightAccordion = [
    {
      value: "What are the design workshops and events conducted by Kreatr?",
      description:
        "To know about creative events and workshops, you can follow us on Instagram and Linkedin. Keep your eyes open– you might even spot our ads on posters, billboards, or even on an ice cream cone!",
    },
    {
      value: "What are the benefits of joining Kreatr?",
      description:
    ...
    {
      value: "How does Kreatr support the design industry as a whole?",
      description:
    ...
    {
      value: "Is Kreatr available for iOS and Android?",
      description:
