          ...
          <div className="flex flex-col items-center justify-center">
            <div className="mt-[44px] sm:mt-[60px] lg:mx-[140px] lg:mt-[74px] lg:w-[990px] xl:mx-[140px] xl:mt-[120px] xl:w-[1125px]">
              ...
              <div className="mt-[24px] flex sm:mt-[28px] lg:mt-[36px] xl:mt-[44px]">
                <div className="content-neue lg:h-[28px]nxl:px-[50px] mr-3 flex h-[14px] w-[46px] items-center justify-center rounded-[24px] border border-[#2A2A2A] text-center text-[10px] text-[#2A2A2A] sm:h-[24px] sm:w-[66px] sm:text-[15px]  lg:px-[50px] lg:text-[18px] xl:h-[34px] xl:text-[24px] ">
                  {pastData.sessionType}
                </div>
