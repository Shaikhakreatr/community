...
const PaymentFailureMain = () => {
  return (
    <div className='h-full lg:mt-[60px] sm:mt-[50px] mt-[80px] mb-[50px] sm:mb-0 w-full flex flex-col justify-center items-center'>
        <Image
