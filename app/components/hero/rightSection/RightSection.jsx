    ...
    <>
      <div className="relative  mx-auto grid h-[200px] w-[320px] max-w-[100%] grid-cols-2 gap-0  sm:grid-cols-2 md:grid-cols-2">
        ...
        <img
          ...
          className="absolute rotate-[-12deg] top-[66%] left-[15%] h-[3.1525rem] w-[8.2613rem]  hover:scale-105 sm:left-[44%] sm:top-[78%] sm:h-[38px] sm:w-[145px] sm:rotate-0 md:right-[5%]  md:top-[91%] md:h-[50px] md:w-[9.875rem] lg:left-[47%] lg:top-[114%] lg:h-[60px] lg:w-[200px] xl:left-[44%] xl:top-[152%] xl:h-[6.6037rem] xl:w-[17.3044rem] "
          alt="events"
        />
        ...
        <img
          ...
          alt="app"
          className=" absolute lg:rotate-[2deg] rotate-[-6deg] left-[40%] top-[21%] h-[4.4863rem] w-[6.9375rem] hover:scale-105 sm:left-[47%] sm:top-[17%] sm:h-[70px] sm:w-[125px] sm:rotate-[-10deg] md:right-[6%] md:top-[12%]  md:h-[90px] md:w-[155px] lg:left-[52%] lg:top-[18%] lg:h-[120px] lg:w-[12.5rem] xl:left-[46%] xl:top-[24%] xl:h-[10.885rem] xl:w-[16.8319rem] "
        />
        <img
        ...
        <img
          ...
          className="absolute sm:rotate-0 rotate-[12deg]  right-[10%] top-[55%] h-[3.1938rem] w-[8.4269rem] hover:scale-105 sm:right-[5%] sm:top-[50%] sm:h-[60px] sm:w-[160px] md:right-[1%] md:top-[56%] md:h-[75px] md:w-[180px] lg:left-[46%] lg:top-[73%] lg:h-[90px]  lg:w-[230px] xl:left-[35%] xl:top-[102%] xl:h-[7.1969rem] xl:w-[18.9906rem]"
          alt="know community"
        />
        <img
          src="/assets/images/home_page/menu_stickers/about-layerblur.svg"
          className=" absolute top-[9%] left-[2%] h-[8.6875rem] w-[8.6875rem] hover:scale-105 sm:left-[16%] sm:top-[8%] sm:h-[120px] sm:w-[120px] md:left-[12%] md:top-[6%] md:h-[140px] md:w-[140px] lg:left-[4%] lg:top-[3%] lg:h-[190px] lg:w-[190px] xl:left-[-18%] xl:top-[13%] xl:h-[14.9875rem] xl:w-[14.9875rem]"
          alt="about kreatr"
        />
        <Image
          className="absolute hidden sm:left-[42%] sm:top-[100%] sm:block sm:h-[126px] sm:w-[5.6875rem] md:left-[37%] md:top-[112%] md:h-[10.375rem] md:w-[6.6875rem] lg:left-[40%] lg:top-[132%] lg:h-[16rem] lg:w-[7.625rem] sm:rotate-[20deg] xl:left-[26%] xl:top-[212%] xl:h-[11.7169rem] xl:w-[8.8463rem] "
          src={ArrowSticker}
        />
        <Image
