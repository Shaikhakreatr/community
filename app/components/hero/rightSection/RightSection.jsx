    ...
    <>
      <div className="relative mx-auto grid h-[200px] w-[320px] max-w-[100%] grid-cols-2 gap-0  sm:grid-cols-2 md:grid-cols-2">
        ...
        <img
          ...
          className="absolute sm:rotate-[-5deg] right-[24%] top-[45%] h-[58.6px] w-[157.56px] hover:scale-105 sm:right-[5%] sm:top-[50%] sm:h-[60px] sm:w-[160px] md:right-[1%] md:top-[56%] md:h-[75px] md:w-[180px] lg:left-[42%] lg:top-[56%] lg:h-[90px]  lg:w-[230px] xl:left-[25%] xl:top-[82%] xl:h-[6.9806rem] xl:w-[18.7694rem]"
          alt="know community"
        />
        <img
