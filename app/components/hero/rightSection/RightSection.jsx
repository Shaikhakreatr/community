...
const RightSection = () => {
  return (
    <>
      <div className="relative lg:mr-[100px]  mx-auto grid h-[200px] w-[320px] max-w-[100%] grid-cols-2 gap-0  sm:grid-cols-2 md:grid-cols-2">
        <Link href="/events">
          <Image
        ...
        <Image
          ...
          className="absolute right-[4%] top-[16%] h-[6.7825rem] w-[5.2794rem] hover:scale-105 sm:right-[48%] sm:top-[58%] sm:h-[100px] sm:w-[80px] md:right-[48%] md:top-[65%] md:h-[120px] md:w-[95px] lg:left-[18%] lg:top-[80%]  lg:h-[160px] lg:w-[120px] xl:left-[0] xl:top-[112%] xl:h-[12.0538rem] xl:w-[9.3825rem]"
          alt="contact"
          height={160}
          width={120}
        />
        ...
        <Image
          ...
          className="absolute right-[14%] top-[59%]  h-[3.1938rem] w-[8.4269rem] rotate-[12deg] hover:scale-105 sm:right-[5%] sm:top-[50%] sm:h-[60px] sm:w-[160px] sm:rotate-0 md:right-[1%] md:top-[56%] md:h-[75px] md:w-[180px] lg:left-[46%] lg:top-[73%] lg:h-[90px]  lg:w-[230px] xl:left-[35%] xl:top-[102%] xl:h-[7.1969rem] xl:w-[18.9906rem]"
          alt="know community"
          height={90}
          width={230}
        />
