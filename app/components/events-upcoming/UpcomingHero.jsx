        ...
        <div className="flex flex-col items-center justify-center">
          <div className="mt-[44px] lg:w-[990px] xl:w-[1125px]  sm:mt-[60px] lg:mt-[74px] xl:mt-[120px]">
            ...
            <div className="mt-[24px] flex sm:mt-[28px] lg:mt-[36px] xl:mt-[44px] ">
              <div className="content-neue mr-3 flex h-[14px]  items-center justify-center rounded-[24px] border border-[#2A2A2A] text-center text-[10px] text-[#2A2A2A] sm:h-[24px] px-[25px] sm:text-[15px] lg:h-[28px]   lg:text-[18px] xl:h-[34px] lg:px-[50px] xl:px-[50px] xl:text-[24px]">
                {upcomingData.sessionType}
              </div>
