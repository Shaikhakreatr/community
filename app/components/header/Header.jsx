        ...
        >
          ...
          >
            <div className="relative mt-[-4px] flex items-center justify-center sm:mt-[-5px] lg:mt-[0px] xl:mt-[1rem]">
              ...
              <Image
                className="pointer-events-none relative mt-[50px] h-[500px] w-[352px] rotate-[-3deg] sm:mt-[50px] sm:h-[710px] sm:w-[480px] lg:mt-0 lg:h-[430px] lg:w-[340px] xl:h-[500px] xl:w-[466px]"
