        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-center lg:mt-[20px] xl:mt-10">
              <div className="absolute left-[29%] top-[24%] lg:left-[35%] lg:top-[28%] xl:left-[35%] xl:top-[30%] ">
                <Image
              ...
              <div className="absolute left-[46%] top-[32%] lg:left-[47%] lg:top-[36%] xl:left-[47%] xl:top-[38%]">
                <Image
