    ...
    <>
      ...
      >
        <div className="flex h-[90px] items-center justify-center border-b border-gray-500 p-2 sm:h-[120px] lg:h-[90px] xl:h-[140px]">
          ...
          >
            <div
              className={`nav-line1 mb-[8px] h-[2px] w-[23px] rounded-[20px] bg-[#2A2A2A] transition-transform duration-300 sm:h-[2px] sm:w-[28px] lg:h-[2px] xl:h-[2px] ${menuOpen ? "translate-y-1.5  rotate-45 transform" : "translate-y-0  rotate-0 transform"}`}
            ></div>
            <div
              className={`nav-line2 h-[2px] w-[23px] rounded-[20px] bg-[#2A2A2A] transition-transform duration-300 sm:h-[2px] sm:w-[28px] lg:h-[2px] xl:h-[2px] ${menuOpen ? "-translate-y-1 -rotate-45 transform" : "translate-y-0 rotate-0 transform"}`}
            ></div>
          </div>
        </div>
        <div
