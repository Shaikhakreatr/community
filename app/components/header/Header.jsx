        ...
        >
          <div
            ...
            <div className="flex items-center justify-center lg:mt-[20px] xl:mt-10">
              <div className="absolute lg:left-[35%] lg:top-[28%] xl:left-[35%] xl:top-[30%] ">
                <Image
              ...
              <div className="absolute lg:left-[47%] lg:top-[36%] xl:left-[47%] xl:top-[38%]">
                <Image
              ...
              <div className="absolute lg:left-[18%] lg:top-[50%] xl:left-[19%] xl:top-[56%]">
                <Image
              ...
              <div className="absolute lg:left-[42%] lg:top-[54%] xl:left-[50%] xl:top-[60%]">
                <Image
              ...
              <div className="absolute lg:left-[15%] lg:top-[78%] xl:left-[20%] xl:top-[80%]">
                <Image
              ...
              <div className="absolute lg:left-[32%] lg:top-[68%] xl:left-[37%] xl:top-[70%]">
                <Image
              ...
              <div className="absolute lg:left-[63%] lg:top-[65%] xl:left-[64%] xl:top-[70%]">
                <Image
