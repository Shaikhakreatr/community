    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-center border-b border-gray-500 p-2">
          ...
          >
            <div
              className={`nav-line1 mb-[8px] h-[2px] w-[25px] rounded-[20px] bg-black transition-transform duration-300 sm:h-[2px] sm:w-[30px] lg:h-[2.8px] ${menuOpen ? "translate-y-1.5  rotate-45 transform" : "translate-y-0  rotate-0 transform"}`}
            ></div>
            <div
              className={`nav-line2 h-[2px] w-[25px] rounded-[20px] bg-black transition-transform duration-300 sm:h-[2px] sm:w-[30px] lg:h-[2.5px] ${menuOpen ? "-translate-y-1 -rotate-45 transform" : "translate-y-0 rotate-0 transform"}`}
            ></div>
          </div>
        </div>
        <div
        ...
        >
          <div
            className={`absolute inset-0 top-[68px] sm:mt-[30px] mt-[29px] lg:mt-[30px] bg-[rgba(190,181,113,0.14)] p-8 sm:backdrop-blur-lg ${styles.menuWrap}`}
            style={{
              transition: "opacity 0.7s ease",
              opacity: menuOpen ? 1 : 0,
            }}
          >
            <div className="relative mt-[-4px] flex items-center justify-center sm:mt-[-5px] lg:mt-[0px] xl:mt-10">
              ...
              <Image
                className="pointer-events-none relative mt-[50px] h-[500px] w-[352px] rotate-[-3deg] sm:mt-[50px] sm:h-[710px] sm:w-[480px] lg:mt-0 lg:h-[460px] lg:w-[340px] xl:h-[676px] xl:w-[466px]"
