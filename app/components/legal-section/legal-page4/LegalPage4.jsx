...
const LegalPage4 = () => {
  return (
    <div>
      ...
      <div className="pb-2 pt-2">Agreement Structure</div>
      ...
      <div className="pb-2">
        <u>Acceptance of the Terms & Conditions</u>
      </div>
      {`This website or mobile application is operated by the Kreatrminds Private
      Limited, its subsidiaries and affiliates (collectively, the “Company,"
      “we," “us," or “our"). The following terms and conditions, together with
      any documents they expressly incorporate by reference (collectively, these
      “Terms & Conditions"), govern your access to and use of our websites,
      including any content, functionality and services offered on or through
      our websites, and our online applications that run on smart phones,
      tablets and other devices which provide dedicated non-browser-based
      interaction between you and our websites (all of which are collectively
      called our “Website"), whether as a guest or a registered user. Please
      read the Terms & Conditions carefully before you start to use the Website.
      By using the Website, you accept and agree to be bound and abide by these
      Terms & Conditions and our Privacy Policy, incorporated herein by
      reference. If you do not want to agree to these Terms & Conditions or the
      Privacy Policy, you must not access or use the Website. Persons who are
      under the age of 18 years of age may only use our Website with legal
      parental or guardian consent. Accordingly, you agree that you are 18 years
      of age or older or possess legal parental or guardian consent, and are
      fully able and competent to enter into the terms, conditions,
      representations and warranties set forth in these Terms & Conditions;
      otherwise, please exit the Website. We suggest that you take advantage of
      any access controls offered through the Website or third-party sites,
      ...
      <div className="pb-2 pt-2">
        <u>Changes to the Terms & Conditions</u>
      </div>
      ...
      <ul className="list-disc pl-4">
        ...
        <li>
          ...
          connection are aware of these Terms & Conditions and comply with them.
        </li>
      </ul>
      ...
      on the Website, is governed by our Privacy Policy, and you consent to all
      ...
      to you and agree not to provide any other person with access to the
      ...
      intellectual property or proprietary rights laws. These Terms & Conditions
      permit you to use the Website for your personal, non-commercial use only.
      ...
      <ul className="list-disc pl-4">
        ...
        <li>
          If we provide social media features with certain content, you make
      ...
      <ul className="list-disc pl-4">
        ...
        <li>
          ...
          notices from copies of materials from the Website.
        </li>
      </ul>
      <br /> <br />
      You must not access or use for any commercial purposes any part of the
      Website or any services or materials available through the Website. If you
      wish to make any use of material on the Website other than that set out in
      this section, please address your request to letstalk@thekreatr.com . If
      you print, copy, modify, download or otherwise use or provide any other
      person with access to any part of the Website in breach of the Terms &
      Conditions, your right to use the Website will cease immediately and you
      must, at our option, return or destroy any copies of the materials you
      have made. No right, title or interest in or to the Website or any content
      ...
      through the Website. All User Contributions must comply with the Content
      Standards set out in these Terms & Conditions. Any User Contribution you
      ...
      grant us and our affiliates and service providers, and each of their and
      our respective licensees, successors and assigns the right to use,
      reproduce, modify, perform, display, distribute and otherwise disclose to
      third parties any such material according to your account settings.`}
      <br />
      ...
      <ul className="list-disc pl-4">
        ...
        <li>
          ...
          believe that such User Contribution violates the Terms & Conditions,
      ...
      DURING OR AS A RESULT OF ITS INVESTIGATIONS AND FROM ANY ACTIONS TAKEN AS
      A CONSEQUENCE OF INVESTIGATIONS BY EITHER THE SUCH PARTIES OR LAW
      ENFORCEMENT AUTHORITIES. However, we do not undertake to review material
      ...
      <ul className="list-disc pl-4">
        ...
        <li>
          ...
          that otherwise may be in conflict with these Terms & Conditions or our
          Privacy Policy.
        </li>
      ...
      send us a notice of copyright infringement to letstalk@thekreatr.com. It
      ...
      of any of its contents. The Website may include content provided by third
      parties, including materials provided by other users. All statements
      and/or opinions expressed in these materials, and all articles and
      responses to questions and other content, other than the content provided
      by the Company, are solely the opinions and the responsibility of the
      ...
      goods or services formed through the Website or as a result of visits made
      by you are governed by our Terms of Sale, which are hereby incorporated
      into these Terms & Conditions. Additional terms and conditions may also
      apply to specific portions, services or features of the Website. All such
      additional terms and conditions are hereby incorporated by this reference
      ...
      <ul className="list-disc pl-4">
        ...
        <li>
          Otherwise take any action with respect to the materials on the Website
      ...
      set out in these Terms & Conditions. You agree to cooperate with us in
      causing any unauthorized framing or linking immediately to cease. We
      reserve the right to withdraw linking permission without notice. We may
      disable all or any social media features and any links at any time without
     ...
     {` YOUR USE OF THE WEBSITE, ITS CONTENT AND ANY SERVICES OR ITEMS OBTAINED
      ...
      BE CORRECTED, THAT OUR WEBSITE OR THE SERVER THAT MAKES IT AVAILABLE ARE
      ...
      Terms & Conditions or your use of the Website, including, but not limited
      ...
      construed in accordance with the laws of Bangalore, Karnataka, without
      giving effect to any choice or conflict of law provision or rule (whether
      of the Bangalore, Karnataka or any other jurisdiction).
      <div className="pb-2 pt-2"></div>
      Any legal suit, action or proceeding arising out of, or related to, these
      Terms & Conditions or the Website shall be instituted exclusively in the
      courts of the Bangalore, Karnataka, although we retain the right to bring
      any suit, action or proceeding against you for breach of these Terms &
      ...
      of the Company to assert a right or provision under these Terms &
      Conditions shall not constitute a waiver of such right or provision.
      <div className="pb-2 pt-2"></div>
      If any provision of these Terms & Conditions is held by a court or other
      ...
      Shariff square, 18/1, Sarjapur - Marathahalli Rd, Jakkasandra, 1st Block
      Koramangala, Bengaluru, Karnataka 560034 <br />
      All notices of copyright infringement claims should be sent to{" "}
      <a href="mailto:letstalk@thekreatr.com" className=" text-hyperLink">
      ...
      . <br />
      Thank you for visiting the Website. <br /> <br />© KREATR All rights
      reserved | Last Modified: 1 November 2023
    </div>
  );
};

export default LegalPage4;
