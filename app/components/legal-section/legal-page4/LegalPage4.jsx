...
const LegalPage4 = () => {
  return (
    <div className="content-neue mt-[0px] text-[14px] leading-[20px] text-[#2A2A2A] sm:mt-[48px] sm:px-[20px] sm:text-[16px] sm:leading-[18px] lg:mt-[40px] lg:text-[16px] lg:leading-[22px] xl:mt-[58px] xl:text-[20px] xl:leading-[26px]">
      ...
      called our “Website"), whether as a guest or a registered user.`}
      <br />
      <br />{" "}
      {`Please
      ...
      <br />
      <br /> Your continued use of the Website following the posting of revised
      ...
      <div className="pt-2">
        ...
        all information you provide to register with the Website or otherwise,
      ...
      <div className="pt-2">
        ...
        the Website or portions of it using your user name, password or other
      ...
      <br />
      <br /> These Terms & Conditions permit you to use the Website for your
      ...
      Terms & Conditions, your right to use the Website will cease immediately
      and you must, at our option, return or destroy any copies of the materials
      you have made. No right, title or interest in or to the Website or any
      content on the Website is transferred to you, and all rights not expressly
      ...
      <br />
      <br />
      <div className="legal_page_h mb-[15px] pb-2 pt-2">Trademarks</div>
      ...
      <br />
      <br />
      <div className="legal_page_h mb-[15px] pb-2 pt-2">Prohibited Uses</div>
      ...
      <br />
      <br />
      <div className="legal_page_h mb-[15px] pb-2 pt-2">User Contributions</div>
      ...
      Standards set out in these Terms & Conditions.`}
      <br />
      <br />{" "}
      {` Any User Contribution you
      ...
      <br />
      <br /> However, we do not undertake to review material before it is posted
      ...
      <br />
      <br />
      <div className="legal_page_h mb-[15px] pb-2 pt-2">Content Standards</div>
      ...
      <br />
      <br /> The Website may include content provided by third parties,
      including materials provided by other users. All statements and/or
      ...
      <br />
      <br />
      <div className="legal_page_h mb-[15px] pb-2 pt-2 leading-[26px]">
      ...
      <br />
      <br /> You agree to cooperate with us in causing any unauthorized framing
      or linking immediately to cease. We reserve the right to withdraw linking
      ...
      <br />
      <br />
      <div className="legal_page_h mb-[15px] pb-2 pt-2">Indemnification</div>
      ...
      . <br />
      <br />
      Thank you for visiting the Website. <br /> <br />© 2024 Kreatrminds
