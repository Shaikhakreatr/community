...
const LegalPage4 = () => {
  return (
    <div className="content-neue text-[16px] leading-[20px] sm:text-[16px] sm:leading-[18px] lg:text-[18px] lg:leading-[22px] xl:text-[22px] xl:leading-[26px] xl:mt-[58px] lg:mt-[40px] sm:mt-[48px] mt-[18px]">
