    ...
    <div>
        ...
        <h1 className='legal_page_h pb-2'><u> GENERAL TERMS </u></h1>
         {`This End User License Agreement (this "Agreement") is a binding agreement between
          ...
          documentation; and (b)access, stream, download and use on such Mobile
          Device the Content and Services (as defined in Section 5) made
         ...
         {` Application may provide you with access to the Company's website
          ...
          and functionality. You agree that the Company has no obligation to
          ...
          all Updates and acknowledge and agree that the Application or portions
          ...
          the Application and all copies thereof from your Mobile Device. (c)
          The Company may terminate this Agreement at any time without notice if
          it ceases to support the Application, which the Company may do in its
          ...
          the terms and conditions of this Agreement. (d) Upon termination: all
          ...
          CAN OR WILL BE CORRECTED. SOME JURISDICTIONS DO NOT ALLOW THE
