...
const LegalPage3 = () => {
  return (
    <div className="content-neue sm:px-[20px] text-[16px] text-[#2A2A2A] leading-[20px] sm:text-[16px] sm:leading-[18px] lg:text-[18px] lg:leading-[22px] xl:text-[22px] xl:leading-[26px] xl:mt-[58px] lg:mt-[40px] sm:mt-[48px] mt-[18px]">
      ...
      (collectively, the “Company," “we" or “our").`}
      <br /> <br />
      To ensure compliance with our refund and cancellation policy, individuals
      under the age of 18 must use our app with explicit consent from a legal
      parent or guardian. By accessing and purchasing our services through the
      app, you confirm that you are either 18 years of age or older, or you have
      obtained the necessary legal parental or guardian consent. You also affirm
      that you possess the full capacity and competence to abide by the terms,
      conditions, representations, and warranties outlined in this policy
      related to the purchase of our services. If you do not meet these
      criteria, we kindly request that you refrain from purchasing our services
      ...
      payment date indicated on the “Payment and Subscription” page. Customers
      who subscribe to our service can cancel their subscription at any time.
      ...
      that you choose when you signed up for the service. In some cases, your
      ...
      paid membership began on a day not contained in a given month. We may
      authorize your Payment Method in anticipation of membership or
      service-related charges through various methods, including authorizing it
      for one month of service as soon as you register. If you signed up for the
      ...
      responsible for any uncollected amounts. If a payment is not successfully
      settled, due to expiration, insufficient funds, or otherwise, and you do
      not cancel your account, we may suspend your access to the service until
      ...
      <br /> <br />
      {`For precise information about when your account will be closed, you can
      check the “Payment History” section under “Settings”. If you initially
      signed up for the Company's service and utilized a third party as your
      Payment Method, and you wish to cancel your membership, please be aware
      that you may need to manage the cancellation through the third-party
      service. This typically involves visiting your account on the respective
      third-party platform and disabling auto-renewal or unsubscribing our
      service there. You can access your subscription settings through our
