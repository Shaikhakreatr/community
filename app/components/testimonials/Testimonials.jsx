...
function Card({  title, people }) {
  return (
    ...
    >  
        ...
        <div className='text-center content-neue xl:mt-[-35px] lg:mt-[-25px] mt-[-20px] px-[10px] text-[14px] leading-[20px] sm:text-[16px] lg:leading-[22px] xl:leading-[26px] lg:text-[18px] xl:text-[22px]'>
        {title}
        </div>
