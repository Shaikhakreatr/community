  ...
  return (
    <div className="  flex flex-col items-center justify-center border-b border-black mb-[30px] xl:mx-[135px] lg:mx-[148px] ">
      <div className="relative xl:mb-[150px] lg:mb-[80px] xl:mt-[40px] lg:mt-0">
        ...
        <div className="absolute rotate-[10deg] xl:top-[60%] xl:right-[-30%] lg:top-[64px] lg:right-[-98px]">
          <img
      ...
      <h3 className="careers-subhead mb-5 text-[18px] sm:text-[25px] lg:text-[30px] xl:text-[36px]">
        Current Openings
      </h3>
    </div>
  );
