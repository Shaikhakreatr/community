  ...
  return (
    <div className="mt-[30px] sm:mt-0 lg:mt-[30px]">
      ...
      <div className="flex flex-col justify-center lg:mt-[60px] xl:mt-[72px] lg:mb-[24px] sm:mt-[40px] mt-[20px]">
        <div className="items-center justify-center sm:ml-[48px] sm:flex">
        ...
        <div className="items-center justify-center mt-[24px] sm:ml-[74px] sm:mt-[24px] sm:flex lg:mt-[24px]">
      ...
      <div className="  flex justify-center mt-[24px] xl:ml-[30px] lg:ml-[60px] sm:ml-[45px] sm:mt-[24px] lg:mt-[44px]">
