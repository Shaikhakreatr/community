    ...
    <div className="my-[60px]">
      <div className="relative mt-[250px] grid-cols-2 sm:mt-0 sm:grid lg:gap-[288px] xl:gap-[240px]">
        <div className="box1 h-[329px] w-[390px] pb-[45px] pl-[45px] pr-[64px] pt-[95px] lg:h-[426px] lg:w-[750px] lg:p-[100px] xl:h-[466px] xl:w-[803px] xl:p-[100px]">
          ...
          <p className="content-neue mt-[15px] lg:mt-[28px] text-center text-[16px]  lg:leading-[24px] leading-[18px] sm:text-start sm:text-[20px] lg:text-[22px] xl:mt-[38px] xl:text-[24px] xl:leading-[23px] ">
      ...
      <div className="relative grid-cols-2 sm:mt-[50px] sm:grid">
        ...
        <div className="box2 mt-[310px] lg:p-[70px] h-[512px] w-[390px] px-[42px] pb-[42px] pt-[90px] sm:mt-0 lg:h-[526px] lg:w-[700px] xl:h-[624px] xl:w-[803px] xl:p-[96px]">
          <h1 className="page-heading text-center text-[40px]  lg:leading-[56px] leading-[35px] sm:text-start sm:text-[60px] lg:text-[70px] xl:text-[80px] xl:leading-[67px]">
            Some REQUIREMETS
            <br /> TO JOIN OUR COMMUNITY
          </h1>
          <ul className="content-neue ml-[26px] lg:mt-[28px] mt-[15px] list-disc text-[16px] lg:leading-[24px] leading-[18px] sm:text-[20px] lg:text-[22px] xl:mt-[38px] xl:text-[24px] xl:leading-[23px]">
      ...
      <div className="relative mt-[300px] grid-cols-2 sm:mt-[50px] sm:grid sm:gap-[240px] lg:gap-[288px]">
        <div className="box3 h-[329px] w-[390px] p-[45px] sm:p-[85px] lg:h-[426px] lg:w-[750px] lg:p-[74px] xl:h-[466px] xl:w-[803px]">
          ...
          <p className="content-neue mt-[15px] text-center text-[16px] lg:leading-[24px] leading-[18px] sm:mt-[38px] sm:text-start  sm:text-[20px] sm:leading-[23px] lg:text-[22px] xl:text-[24px]">
            Joining our community allows you to connect with fellow creatives,
            collaborate, and find inspiration.
          </p>
          <p className="content-neue mt-[15px] text-center text-[16px] lg:leading-[24px] leading-[18px] sm:text-start sm:text-[20px] sm:leading-[23px] lg:text-[22px] xl:text-[24px]">
      ...
      <div className="relative mt-[280px] grid-cols-2 sm:mt-[50px] sm:grid">
        ...
        <div className="box4 h-[329px] w-[390px] px-[48px] pb-[48px] pt-[80px] sm:p-[96px] lg:h-[426px] lg:w-[700px] lg:p-[85px] xl:h-[466px] xl:w-[803px]">
          ...
          <p className="content-neue mt-[24px] list-disc lg:leading-[24px] text-center text-[16px] leading-[18px] sm:mt-[38px] sm:text-start sm:text-[20px] lg:text-[22px] xl:text-[24px] xl:leading-[23px]">
